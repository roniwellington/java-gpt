...
public class AnaliseDeSentimentos {
    public static void main(String[] args) throws InterruptedException {
        ...
        for (var arquivo : arquivosDeAvaliacoes) {
            System.out.println("Inicinando análise do produto: " + arquivo.getFileName());
            var resposta = enviarRequisito(arquivo);
    ...
    private static String enviarRequisito(Path arquivo) throws InterruptedException {
    ...
    private static void salvarArquivoDeAnaliseDeSentimento(Path arquivo, String analise) {
        try {
            ...
            throw new RuntimeException("Eerro ao salvar o arquivo!", e);
        }
    }
}
